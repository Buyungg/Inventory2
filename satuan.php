	      							...
	      							<table id="example1" class="table table-bordered table-striped">
										  ...
										  <?php
                                            ...
                                            ?>
	      									...
	      									<tr>
                                                ...
                                                <td><?=$namasatuan;?></td>
	      										<td>
	      											<a href="#">
	      												<i class="fas fa-trash" style="color: red" data-toggle="modal" data-target="#delete<?=$ids;?>"></i>
	      											</a>
	      										</td>
	      									</tr>
											<!-- Delete -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                Apakah Anda Yakin Ingin Menghapus (<?=$namasatuan;?>) ?
                                                <input type="hidden" name="idsatuan" value="<?=$ids;?>">
                                                <br>
                                                <br>
