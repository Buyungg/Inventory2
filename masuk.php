											  ...
											  <td><?=$i++;?></td>
                                                ...
                                                <td>Rp. <?=number_format($total, 0, '','.');?></td>
	      										<td>
	      											...
	      											<a href="#">
	      												<i class="fas fa-trash" style="color: red" data-toggle="modal" data-target="#delete<?=$idm;?>"></i>
	      											</a>
	      										</td>
	      									</tr>
            ...
            <form method="post">
            	<div class="modal-body">
            		...
            		<div class="modal-footer justify-content-between">
            			...
            			<button type="submit" class="btn btn-success swalDefaultSuccess" name="barangmasuk">Simpan</button>
            		</div>
            	</div>
            </form>
          <!-- /.modal-content -->
